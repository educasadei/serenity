...
ErrorOr<int> serenity_main(Main::Arguments arguments)
{
    ...
    auto open_settings_action = GUI::Action::create("Maps &Settings", { Mod_Ctrl, ',' }, TRY(Gfx::Bitmap::load_from_file("/res/icons/16x16/app-settings.png"sv)), [window](GUI::Action const&) {
