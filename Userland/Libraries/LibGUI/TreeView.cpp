...
TreeView::TreeView()
{
    ...
    m_expand_bitmap = MUST(Gfx::Bitmap::load_from_uri("resource://icons/serenity/treeview-expand.png"sv));
    m_collapse_bitmap = MUST(Gfx::Bitmap::load_from_uri("resource://icons/serenity/treeview-collapse.png"sv));
}
