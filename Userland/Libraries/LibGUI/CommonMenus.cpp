...
{
    auto default_accessibility_action = Action::create_checkable("Unimpaired", { Mod_AltGr, KeyCode::Key_1 }, [&](auto&) {
        filterer.set_color_filter(nullptr);
    });
    auto pratanopia_accessibility_action = Action::create_checkable("Protanopia", { Mod_AltGr, KeyCode::Key_2 }, [&](auto&) {
        filterer.set_color_filter(Gfx::ColorBlindnessFilter::create_protanopia());
    });
    auto pratanomaly_accessibility_action = Action::create_checkable("Protanomaly", { Mod_AltGr, KeyCode::Key_3 }, [&](auto&) {
        filterer.set_color_filter(Gfx::ColorBlindnessFilter::create_protanomaly());
    });
    auto tritanopia_accessibility_action = Action::create_checkable("Tritanopia", { Mod_AltGr, KeyCode::Key_4 }, [&](auto&) {
        filterer.set_color_filter(Gfx::ColorBlindnessFilter::create_tritanopia());
    });
    auto tritanomaly_accessibility_action = Action::create_checkable("Tritanomaly", { Mod_AltGr, KeyCode::Key_5 }, [&](auto&) {
        filterer.set_color_filter(Gfx::ColorBlindnessFilter::create_tritanomaly());
    });
    auto deuteranopia_accessibility_action = Action::create_checkable("Deuteranopia", { Mod_AltGr, KeyCode::Key_6 }, [&](auto&) {
        filterer.set_color_filter(Gfx::ColorBlindnessFilter::create_deuteranopia());
    });
    auto deuteranomaly_accessibility_action = Action::create_checkable("Deuteranomaly", { Mod_AltGr, KeyCode::Key_7 }, [&](auto&) {
        filterer.set_color_filter(Gfx::ColorBlindnessFilter::create_deuteranomaly());
    });
    auto achromatopsia_accessibility_action = Action::create_checkable("Achromatopsia", { Mod_AltGr, KeyCode::Key_8 }, [&](auto&) {
        filterer.set_color_filter(Gfx::ColorBlindnessFilter::create_achromatopsia());
    });
    auto achromatomaly_accessibility_action = Action::create_checkable("Achromatomaly", { Mod_AltGr, KeyCode::Key_9 }, [&](auto&) {
