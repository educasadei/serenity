...
{
    m_overflow_action = Action::create("Overflow Menu", { Mod_Ctrl | Mod_Shift, KeyCode::Key_O }, TRY(Gfx::Bitmap::load_from_uri("resource://icons/16x16/overflow-menu.png"sv)), [&](auto&) {
